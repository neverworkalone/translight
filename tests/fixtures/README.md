...
aligned after the viewport crosses the mobile breakpoint.

The repaired case must report equal `sourceLayout` and `translationLayout`,
`translationCount: 2`, `restoredAfterStop: true`, and `testPassed: true`.
